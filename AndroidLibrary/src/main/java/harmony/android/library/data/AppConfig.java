...
public class AppConfig {
    ...
    public static final boolean IS_CRASHLYTICS_DEBUG = false;
    public static final boolean IS_FLURRY_DEBUG = false;
    ...
    // Facebook
    public static final String FACEBOOK_APP_NAMESPACE = "pitch6";

    // Flurry
    public static final String FLURRY_API = "QHM9Q7NKCBQCVMPS6MBD";
